      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">All Students in (<?php echo htmlspecialchars($rrw['className'] . ' - ' . $rrw['classArmName']); ?>) Class</h1>
            <ol class="breadcrumb">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="table-responsive p-3">
                      <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                        ...
                        <tbody>
                          <?php
                            $query = "SELECT tblstudents.Id, tblstudents.surname, tblstudents.name, tblstudents.mobile, tblstudents.aadharNumber
                            ...
                            if ($num > 0) {
                              while ($rows = $rs->fetch_assoc()) {
                                ...
                                echo "<tr>
                                        ...
                                        <td>" . htmlspecialchars($rows['aadharNumber']) . "</td>
                                      </tr>";
                              }
                            } else {
