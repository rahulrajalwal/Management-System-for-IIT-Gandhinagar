...
<nav class="navbar navbar-expand navbar-light bg-gradient-primary topbar mb-4 static-top">
  ...
  <!-- Clock time and login/logout recording -->
  <div class="d-none d-sm-block form-inline mr-auto text-white-50">
    <span class="text-white-50 mr-2">
      <i class="fas fa-clock fa-fw"></i>
      <span id="clockTime"><?php echo $currentTime; ?></span>
    </span>
...
<script>
  ...
  window.onunload = function() {
      ...
      var minutes = currentTime.getMinutes().toString().padStart(2, "0");
      var seconds = currentTime.getSeconds().toString().padStart(2, "0");
      logoutTime.textContent = hours + ":" + minutes + ":" + seconds;
  };
</script>
